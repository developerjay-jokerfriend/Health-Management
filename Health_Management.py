...
def Menu():
    ...
    while(True):
        ...
        elif int(menu_choice)==3: Retrieve_Activity()
        else: print("Please enter correct input!\n")

def Register():
    # User Registration
    print("\n======== PRESS # anytime to go back to MENU =======")
    ...
    for key in buffer:
        ...
        if uname==key and pwd==val:
            ...
            print("\n============================================\n",
                  ...
                  "============================================")
            return True
    print("\nXXX Invalid Username or Password ! XXX\n")
    return False
